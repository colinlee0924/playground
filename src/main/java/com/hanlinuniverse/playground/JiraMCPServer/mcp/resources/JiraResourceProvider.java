...
import io.modelcontextprotocol.sdk.McpSchema.Resource;
    ...
    private McpServerFeatures.SyncResourceSpecification createProjectResource() {
        return new McpServerFeatures.SyncResourceSpecification(
            ...
            (exchange, request) -> {
                ...
                return new ReadResourceResult(mockProjectData);
            }
        );
    }
    ...
    private McpServerFeatures.SyncResourceSpecification createIssueResource() {
        return new McpServerFeatures.SyncResourceSpecification(
            ...
            (exchange, request) -> {
                ...
                return new ReadResourceResult(mockIssueData);
            }
        );
    }
    ...
    private McpServerFeatures.SyncResourceSpecification createProjectDocumentationResource() {
        return new McpServerFeatures.SyncResourceSpecification(
            ...
            (exchange, request) -> {
                ...
                return new ReadResourceResult(mockDocumentation);
            }
        );
    }
}